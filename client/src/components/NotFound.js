        ...
        <NotFoundContainer>
            <div className="content">
                ...
                <div className="txt">
                    ...
                    <span>Browse our <Link to="/">recent questions</Link></span>
                </div>
            </div>
        </NotFoundContainer>
    )
