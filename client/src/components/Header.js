    ...
    return (
        <HeaderWrap>
            <HeaderContainer>
                ...
                (<ul className="nav-login">
                    <li className="members">
                        <Link className="my" to="/">
                            <svg className="members-icon" width="24" heigth="24" viewBox="0 0 1000 1000">
                    ...
                    <li className="members">
                        <Link to="/">
                            <svg className="members-icon" width="20" height="18" viewBox="0 0 20 18">
                    ...
                    <li className="members">
                        <Link to="/">
                            <svg className="members-icon" width="18" height="18" viewBox="0 0 18 18">
                    ...
                    <li className="members wd38">
                        <Link to="/logout">
                        <svg className="members-icon" width="28" height="28" viewBox="0 0 50 30">
                ...
                (<ul className="nav-login">
                    <li className="non-members"><Link to="/login">Log in</Link></li>
                    <li className="non-members"><Link to="/signup">Sign Up</Link></li>
                </ul>)}
            </HeaderContainer>
        </HeaderWrap>
    )
